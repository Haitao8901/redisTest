...
public class App 
{
    public static void main( String[] args ) throws Exception
    {
        ...
        String msg6 = "<message><header><action value=\"conversation\"/><sessionid value=\"ssnxiao\"/><userid value=\"nxiao\"/><debugid value=\"off\"/></header><body><debug><path><location id=\"cyberobject/httest/Document/testrex.rex#s1.88-o10\"/></path></debug></body></message>";
        String msg7 = "<message><header><action value=\"conversation\"/><sessionid value=\"ssnxiao\"/><userid value=\"nxiao\"/><debugid value=\"off\"/></header><body><debug><path><location id=\"cyberobject/httest/Document/testrex.rex#s1.88-o11\"/></path></debug></body></message>";

        String msg8 = "<message><header><action value=\"console\"/><session value=\"http://www.cyberobject.com/2012/12/session#2ff30710-23d2-11e7-8d85-cb013b907cba_enrollment_chat\"/><from value=\"workflow.199\"/><to value=\"sdecf76abd8254e409c8c45b9221000aa\"/><org value=\"cyberobject\"/><app value=\"enrollment_chat\"/><user value=\"http://www.cyberobject.com/2012/12/session#2ff30710-23d2-11e7-8d85-cb013b907cba_enrollment_chat\"/></header><body><debug><message type=\"error\" id=\"cyberobject/httest/Document/Enrollment greeting.rex#s1.88-o65\">go the sharp</message></debug></body></message>";
...
//        String msg = "<message><header><action value=\"conversation\"/><sessionid value=\"ssnxiao\"/><userid value=\"nxiao\"/><debugid value=\"off\"/></header><body><debug><message type=\"error\" id=\"cyberobject/ntelagent/Document/Close_POTS_0225.vsd#s0.10\">hi everybody</message></debug></body></message>";
        ...
        long sleeptime = 1000;
        String key = "sc8375a2714734767ab85961e76947137".trim();
